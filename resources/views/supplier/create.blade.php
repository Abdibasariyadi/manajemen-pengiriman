                        ...
                        <div class="col-md-6 col-xs-12">
                          ...
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="company_name" class="form-control" id="exampleInputEmail1" placeholder="Company Name" required="">
                            </div>

                            <div class="form-group">
                              <label for="exampleInputEmail1">No NPWP</label>
                              <input type="text" name="no_npwp" class="form-control" id="exampleInputEmail1" placeholder="No NPWP">
                            </div>

                            <div class="form-group">
                              <label for="exampleInputEmail1">No Telp</label>
                              <input type="text" name="no_telp" class="form-control" id="exampleInputEmail1" placeholder="No Telp">
                            </div>
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="kota" class="form-control" id="exampleInputEmail1" placeholder="Kota">
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="kode_pos" class="form-control" id="exampleInputEmail1" placeholder="Kode Pos">
                                </div>

                                <div class="form-group">
                                  <label for="exampleInputEmail1">Alamat Lengkap</label>
                                  <textarea class="form-control" name="alamat_lengkap" rows="5"></textarea>
                                </div>
