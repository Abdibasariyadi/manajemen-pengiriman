...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
               <div class="row">
                   <form method="post" action="{{url('paket-laundry/create')}}">
                      @csrf
                     <div class="col-md-6">
                       ...
                       <div class="box-body">
                        <div class="form-group">
                          ...
                          <input type="text" name="nama" class="form-control" id="exampleInputEmail1" placeholder="Nama Paket" required="">
                        </div>

                        <div class="form-group">
                          <label for="exampleInputPassword1">Harga Per Satuan</label>
                          <input type="number" name="harga" class="form-control" id="exampleInputPassword1" placeholder="Harga" required="">
                        </div>
                     ...
                     <div class="col-md-6">
                         <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="number" name="estimasi_pengerjaan" class="form-control" id="exampleInputEmail1" placeholder="Estimasi Pengerjaan" required="">
                          </div>
                          <div class="form-group">
