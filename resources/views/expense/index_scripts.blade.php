<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('body').on('click','.check-expense-all',function(e){
            ids=[];
            if($(this).is(':checked')){
                 $('.check-expense').each(function(i,v){
                    var nilai = $(this).val();
        ...
        $('body').on('click','.check-expense',function(e){
            ids=[];
             $('.check-expense').each(function(i,ee){
                if($(this).is(':checked')){
                     var nilai = $(this).val();
                    ids.push(nilai);
                }else{
