        ...
        <div class="box box-warning">
            <div class="box-header">
                <p>
                    ...
                    <a href="{{url('admin/expense/create')}}" class="btn btn-sm btn-flat btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            ...
            <div class="box-body">
              <div class="row form-filter" style="display: none;">
                <div class="col-md-4 col-xs-12">
                    <form role="form" method="get" action="{{url('admin/expense/filter')}}">
                      <div class="box-body">
               ...
               <div class="row">
                   <div class="col-md-12">
                       <div class="table-responsive">
                           <table class="table tbl-expense">
                               <thead>
                                   <tr>
                                       <th>
                                           <input type="checkbox" class="check-expense-all"> Verifikasi
                                       </th>
                                       <th>Action</th>
                                       <th>Tanggal</th>
                                       <th>Ref No</th>
