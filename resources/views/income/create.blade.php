    ...
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <form role="form" method="POST" action="{{url('admin/income/create')}}">
                @csrf
                      ...
                      @endif
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Income No" required="" name="ref_no" value="{{$ref_no}}">
                            </div>
                            <div class="form-group">
